...
// approved er kaj
if(isset($_POST['update_approved'])){
    $update_p_id = $_POST['update_p_id'];
    $update_p_cus_id = $_POST['update_p_cus_id'];
    $update_p_pid= $_POST['update_p_pid'];
   ...
   $update_query = mysqli_query($conn, "INSERT INTO `approved`(cus_id,pid,name,number,email,method,flat,street,city,state,country,pin_code,total_products,total_price,status,date) VALUES('$update_p_cus_id','$update_p_pid','$update_p_name','$update_p_number','$update_p_email','$update_p_method','$update_p_flat','$update_p_street','$update_p_city','$update_p_state','$update_p_country','$update_p_pin_code','$update_p_total_products','$update_p_total_price','$update_p_status','$update_p_date')") or die('query failed');
   if($update_query){
   ...
   <table>
      ...
      <tbody>
         ...
         <tr>
            ...
            <td>
               <a href="order.php?delete=<?php echo $row['id']; ?>" class="delete-btn" onclick="return confirm('Delete this order?');"> <i class="fas fa-trash"></i> Cancel </a>
               <a href="order.php?edit=<?php echo $row['id']; ?>" class="option-btn"> <i class="fas fa-edit"></i> Update </a>
               <a href="order.php?approved=<?php echo $row['id']; ?>" class="approve-btn"> <i class="fa-solid fa-stamp"></i>Approve</a>
            </td>
         </tr>
...
<!-- approved -->
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="submit" value="Approve the order" name="update_approved" class="btn">

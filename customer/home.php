...
<head>
    ...
    <link rel="stylesheet"
        href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css?v=<?php echo time(); ?> " />

    <link rel="stylesheet" href="style_4.css?v=<?php echo time(); ?> " />
...
<body>
    ...
    <header class="header">
        ...
        <div class="header-1">
            ...
            <div class="icons">
                ...
                <div id="login-btn" class="fas fa-user"> <a href="../logout.php">log Out</a></div>
        ...
        <div class="header-2">
            <?php
                   echo "<h1 style='color:#FFFFFF; text-align:center;'>"."Welcome : ".$p."</h1>"; 
                   ?>
            <nav class="navbar">
 ...
 -->
    ...
    <section class="about" id="about">
        ...
        <h1>Today is : <?php echo date('D M Y') ?>
        ...
        echo "<div class='fakeimg' style='height:400px;'><img src='../uploadedimage/$image' height=400px' width='400px'>  </div> ";
       echo "<h2>Hello I am : ' $name '</h2>";
        echo "<h3><b>Adress : </b>$adds</br> <b>Mobile : </b>$mbl</br> <b>Email : </b>$email</br> </h3> ";
